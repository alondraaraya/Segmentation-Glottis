...
class DataGenerator(Sequence):   
    ...
    def __init__(self, imgs, segs, batch_size, target_height = 512, target_width = 256, 
    ...
    def on_epoch_end(self):
        ...
        # Shuffle images
        if self.shuffle:
            self.segs = self.segs.sample(frac=1, random_state=self.random).reset_index(drop=True)
